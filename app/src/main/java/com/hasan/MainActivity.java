...
public class MainActivity extends AppCompatActivity {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    List<Reminders> list = roomDAO.getAll();
                    reminders = list.get(list.size()-1);
                    ...
                    Toast.makeText(MainActivity.this, "Date and Time not selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void setItemsInRecyclerView(){
        ...
        List<Reminders> list = dao.orderTheTable();
        if(list.size()>0) {
            empty.setVisibility(View.INVISIBLE);
            recyclerView.setVisibility(View.VISIBLE);
        }
        AdapterReminders adapter = new AdapterReminders(getApplicationContext(), list);
